...
- **Next — Codex capability spike:** verify native multi-agent invariants before the early dogfood cutover.
...
- **Baseline:** task #40's full gate was green at `1329e0a`; release 3.0.0 is pending integration.

## NEXT

### 2. Codex capability spike
...
### 3. Minimum native Codex plugin + early dogfood cutover
